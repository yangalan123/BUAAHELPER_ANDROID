...
public class SQLiteUtils {
    ...
    public String GetNotificationsOrderByUpdateTime(int from, int size, String owner) {
        ...
        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read FROM notifications WHERE (owner= ? AND show=1)ORDER BY updated_at DESC LIMIT ? OFFSET ?";
    ...
    public String GetFAVNotificationsOrderByUpdateTime(int from, int size, String owner) {
        ...
        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read FROM notifications WHERE (owner= ? AND show=1 AND star=1)ORDER BY updated_at DESC LIMIT ? OFFSET ?";
    ...
    public String GetNotificationByID(long id) {
        ...
        final String SQL_DATA_QUERY_LASTUserNToken = "SELECT id,updated_at,title,author,content,files,star,show,read FROM notifications WHERE id= ? ";
